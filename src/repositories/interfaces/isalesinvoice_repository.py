...
class ISalesInvoiceRepository(ABC):
    ...
    @abstractmethod
    async def get_sales_invoice_with_details(
        self, salesinvoice_id: int
    ) -> SalesInvoice:
        pass

    @abstractmethod
    async def add_sales_invoice_detail(
        self, entity: SalesInvoiceDetail
    ) -> SalesInvoiceDetail:
        pass
    ...
    @abstractmethod
    async def update_sales_invoice(self, invoice: SalesInvoice) -> SalesInvoice:
        pass
